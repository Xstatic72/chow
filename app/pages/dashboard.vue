        ...
        <div class="grid grid-cols-4 gap-4 p-4 pt-8">
            ...
            >
                ...
                <div class="absolute flex items-center bottom-4 left-4 z-10">
                    ...
                    <button @click="getRandomMeal" class="btn flex items-center p-4 bg-transparent border border-b-emerald-800 transition-colors duration-300">Something else <Shuffle class="ml-1" /></button>
                </div>
            </div>
